      ...
      <main className="flex-1 px-4 py-6 max-w-lg mx-auto w-full">
        ...
        {isMember && (
          <div className="grid grid-cols-2 gap-3 mt-4">
            <Link
              href="/benefits"
              className="flex items-center justify-center gap-2 py-3 bg-white border border-gray-200 text-center rounded-xl font-medium hover:bg-gray-50 transition-colors"
            >
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M3 10h2V8H3v2zm0 4h2v-2H3v2zm0 4h2v-2H3v2zm4-12h2V4H7v2zm0 12h2v-2H7v2zm4-12h2V4h-2v2zm0 4h2V8h-2v2zm0 4h2v-2h-2v2zm0 4h2v-2h-2v2zm4-12h2V4h-2v2zm0 12h2v-2h-2v2zm4-12h2V4h-2v2zm0 4h2V8h-2v2zm0 4h2v-2h-2v2zm0 4h2v-2h-2v2z" />
              </svg>
              혜택 QR
            </Link>
          </div>
